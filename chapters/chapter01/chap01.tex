...
Now this approximation of $u_{xx}$ can be used on a grid. 
...
We can also describe both iterations in terms of matrices. Then we split \textit{A} into three parts, a strictly lower triangular, a diagonal and a strictly upper triangular part:
...
\begin{figure}[h]
	...
	\caption{The Cray-1 was the first supercomputer that implemented a vector processor design. It was first employed in 1976.} %https://commons.wikimedia.org/wiki/File:Cray-1-deutsches-museum.jpg
	\label{fig:cray_1}
\end{figure}
