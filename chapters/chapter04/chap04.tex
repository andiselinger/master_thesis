...
%That means that if the rows that have to be merged contain many non-zeros, the Intel algorithm should be used, while the \textit{rowmerge} algorithm is better suited for rows with few non-zeros.
