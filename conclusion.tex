...
The performance of parallel matrix-matrix multiplication algorithms also proved to be dependent on the used stencil. Similar to the sequential case, the new implementation (\textit{sequential MPI}) rendered the best results for big stencils. % For the biggest stencil, it needs only two thirds of time non-scalable needs.
